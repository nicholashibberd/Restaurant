BEGIN TRANSACTION;
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY NOT NULL, "name" varchar(255), "email" varchar(255), "created_at" timestamp, "updated_at" timestamp, "encrypted_password" varchar(255), "salt" varchar(255), "remember_token" varchar(255), "status" varchar(255));
