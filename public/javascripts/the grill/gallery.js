...
$("li.thumb").click(function () {
	...
	if ( thisindex == selectedindex + 1 ){
		$("#gallery_inner").animate({"left": "-=604px"}, "medium");
	}	

	if ( thisindex == selectedindex + 2 ){
		$("#gallery_inner").animate({"left": "-=1208px"}, "medium");
	}	

	if ( thisindex == selectedindex + 3 ){
		$("#gallery_inner").animate({"left": "-=1812px"}, "medium");
	}	
